...
public:
  ...
  // added by vlad to allow update of flops even when ANN_PERF is not defined
  //   this gives user choice between speed and stats at runtime
  virtual void ann_FR_searchFlops(ANNdist)=0;	// fixed-radius search
...
public:
  ...
  // added by Vlad to always update flops, even if ANN_PERF is not defined
  virtual void ann_FR_searchFlops(ANNdist);		// fixed-radius search
};
...
public:
  ...
  // added by Vlad on 5-1-08 so that flops are updated even when ANN_PERF is not defined
  virtual void ann_FR_searchFlops(ANNdist);		// fixed-radius search
};
