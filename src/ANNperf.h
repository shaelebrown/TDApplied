...
// defined by Vlad (05-01-2008) to get flop count even in Release version for some functions,
//    while keeping the main functions fast
#define ANN_FLOP_ALWAYS(n)	{ann_Nfloat_ops += (n);}
// end Vlad's modification
...
DLL_API extern int			ann_Nfloat_ops;	// floating ops for one query // DLL_API added by vlad 4/30/08
...
DLL_API extern ANNsampStat	ann_float_ops;	// stats on floating ops  // DLL_API added by vlad 4/30/08
//----------------------------------------------------------------------
