...
```{r}
# D1
ggplot(data = data.frame(Birth = 2,Death = 3),aes(x = Birth,y = Death)) + geom_point() + xlim(0,6) + geom_abline(slope = 1,intercept = 0) + ylim(0,6) + ggtitle(bquote("" ~ D[1])) + theme(plot.title = element_text(hjust = 0.5))

# D2
ggplot(data = data.frame(Birth = c(2,5),Death = c(3.1,6)),aes(x = Birth,y = Death)) + geom_point() + xlim(0,6) + geom_abline(slope = 1,intercept = 0) + ylim(0,6) + ggtitle(bquote("" ~ D[2])) + theme(plot.title = element_text(hjust = 0.5))

# D3
ggplot(data = data.frame(Birth = c(1,3),Death = c(1.1,3.1)),aes(x = Birth,y = Death)) + geom_point() + xlim(0,6) + geom_abline(slope = 1,intercept = 0) + ylim(0,6) + ggtitle(bquote("" ~ D[3])) + theme(plot.title = element_text(hjust = 0.5))
...
```{r}
diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(2,5),death = c(3.1,6)),p = 2,distance = "wasserstein")

diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(2,5),death = c(3.1,6)),p = 2,distance = "Turner")

diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(2,5),death = c(3.1,6)),p = Inf,distance = "Turner")
...
```{r}
diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = 2,distance = "wasserstein")

diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = 2,distance = "Turner")

diagram_distance(D1 = data.frame(birth = 2,death = 3),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = Inf,distance = "Turner")
...
```{r}
diagram_distance(D1 = data.frame(birth = c(2,5),death = c(3.1,6)),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = 2,distance = "wasserstein")

diagram_distance(D1 = data.frame(birth = c(2,5),death = c(3.1,6)),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = 2,distance = "Turner")

diagram_distance(D1 = data.frame(birth = c(2,5),death = c(3.1,6)),D2 = data.frame(birth = c(1,3),death = c(1.1,3.1)),p = Inf,distance = "Turner")
