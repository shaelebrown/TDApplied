...
```{r,echo = F,out.width="10%", out.height="10%",fig.show="hold",fig.align = 'center'}
...
```{r,echo = F,fig.align = 'center',out.width="100%",out.height="100%",fig.cap="Activity of theta-responding nodes at various loop angles."}
