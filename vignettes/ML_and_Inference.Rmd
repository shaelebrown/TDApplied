...
It is with these goals that the package TDApplied was created. However, in order to make TDApplied a self-contained package for topological data analysis functionality is included for plotting persistence diagrams, determining which topological features are "real" in a dataset, and quickly calculating persistence diagrams with python.
