...
3. We calculate the bottleneck distance of each new diagram with the original, either in each dimension separately (obtaining one threshold for each dimension) or for all points altogether, and compute the $1-\alpha$ percentile of these values (in each dimension or altogether as was calculated).
