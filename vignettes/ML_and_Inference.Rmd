...
The parameters to the function are the numbers of copies desired from each of D1, D2 and D3. So, for example, the code `generate_TDApplied_test_data(3,3,3)` would generate a list of three noisy copies of D1 follows by three noisy copies of D2 followed by three noisy copies of D3.
