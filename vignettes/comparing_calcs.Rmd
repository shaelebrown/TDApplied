...
```{r,echo = F}
bottleneck_comparison <- data.frame(pair = c("D1 and D2","D1 and D3","D2 and D3"),ground_truth = c(0.3,0.5,0.65),TDApplied = c(0.3,0.5,0.65),TDA = c(0.3,0.5,0.65),TDAstats = c(0.8,0.5,1.3),rgudhi = c(0.3,0.5,0.65))
bottleneck_comparison
```
...
```{r,echo = F}
wasserstein_comparison <- data.frame(pair = c("D1 and D2","D1 and D3","D2 and D3"),ground_truth = c(0.3905125 ,0.559017 ,0.65),TDApplied = c(0.3905125,0.559017,0.65),TDA = c(0.55,0.75,0.65),TDAstats = c(0.8,0.5,1.3),rgudhi = c(0.55,0.75,0.65))
wasserstein_comparison
```
...
```{r,echo = F}
fisher_comparison <- data.frame(pair = c("D1 and D2","D1 and D3","D2 and D3"),ground_truth = c(0.02354624 ,0.08821907 ,0.11398910),TDApplied = c(0.02354624 ,0.08821907 ,0.11398910),rgudhi = c(0.02354624 ,0.08821907 ,0.08741134))
fisher_comparison
```
