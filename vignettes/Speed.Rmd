...
(4) Fisher information metric distances between persistence diagrams with TDApplied's `diagram_distance` and rgudhi's [@rugdhi] `PersistenceFisherDistance`.
